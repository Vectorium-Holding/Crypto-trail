        ...
        <div className="flex items-center">
          <Card className="border-none bg-transparent">
            <CardHeader className="text-center text-[#cfcbbf]">
              ...
              <CardDescription className="text-[22.5px] font-prata">
                Always Open
              </CardDescription>
              <CardDescription className="text-[18px] font-raleway">
          ...
          <Card>
            <CardTitle className="text-[59.4px] font-prata">24/7</CardTitle>
            <CardDescription className="text-[22.5px] font-prata text-inherit">
              Always Open
            </CardDescription>
            <CardDescription className="text-[18px] font-raleway text-inherit">
              Trade carbon credits around the clock, unlike traditional markets.
            </CardDescription>
          </Card>
          ...
          <Card className="border-none bg-transparent text-[#cfcbbf]">
            ...
            <CardDescription className="text-[18px] font-raleway text-inherit">
              Start trading in minutes with our streamlined onboarding process.
            </CardDescription>
          </Card>
        </div>
      </div>
