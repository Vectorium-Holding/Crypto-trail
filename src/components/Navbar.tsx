...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-20 flex items-center justify-between bg-gradient-to-r from-[#373636] via-[#212120] to-[#0b0b0b] px-10">
      {/* Logo */}
      <Link href="/">
      ...
      {/* Navigation Links */}
      <div className="flex gap-12 font-prata text-md bg-gradient-to-r from-[#C4A44D] via-[#f7f595] to-[#C4A44D] bg-clip-text text-transparent leading-relaxe">
