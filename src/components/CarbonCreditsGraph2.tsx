...
const CarbonCreditsGraph2 = () => {
    ...
    return (
        <section className="bg-[#e7e4e4] rounded-b-2xl w-3/5 mx-12 h-1/6 p-6">
            <Label className="pl-8 mb-4 text-2xl font-bold">Carbon Credits</Label>
            <div className="flex items-center justify-start gap-28">
                <ChartContainer config={chartConfig} className="max-h-[350px] w-3/4 pt-8">
                ...
                {/* Right-Side Card */}
                <Card className="bg-gradient-to-b rounded-3xl from-[#F7E374] via-yellow-900 to-black w-[230px] h-[200px] flex flex-col justify-end p-4 text-white shadow-slate-950">
                    <CardFooter className="text-[22px] text-center font-bold">
